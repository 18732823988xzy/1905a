...
<body>
            ...
            <h1>文章添加</h1>
                ...
                <form action="{{url('news/store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    文章标题 <input type="text" name="news_title"> <br>
                    文章分类 <select name="news_cate" id="">
                    ...
                    文章作者 <input type="text" name="news_writer"><br>
                    作者email <input type="text" name="news_email"><br>
                    关键字 <input type="text" name="news_key"><br>
